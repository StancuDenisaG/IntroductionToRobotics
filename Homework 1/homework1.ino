...
void loop() {
  ...
  redLedValue = map(redPotValue, 0, maxAnalogValue, 0, maxLedValue);
  greenLedValue = map(greenPotValue, 0, maxAnalogValue, 0, maxLedValue);
  blueLedValue = map(bluePotValue, 0, maxAnalogValue, 0, maxLedValue);
